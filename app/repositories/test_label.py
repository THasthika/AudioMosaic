...
class TestLabelRepository:
    ...
    def test_create(self):
        ...
        create_schema = LabelCreate(
            dataset_id=dataset_id, name="Hello", description="Hello Desc", color="#fff")
    ...
    def test_bulk_create(self):
        ...
        create_schemas = [
            LabelCreate(dataset_id=dataset_id, name="Hello",
                        description="Hello Desc", color="#fff"),
            LabelCreate(dataset_id=dataset_id, name="Hello 1",
                        description="Hello Desc 1", color="#ffe"),
        ]
        ...
        assert all([created_models[i].color ==
                   create_schemas[i].color for i in range(len(create_schemas))])
    ...
    def test_update(self, mock_sqlalchemy_orm):
        ...
        db = mock_sqlalchemy_orm(
            ['query', 'filter'], ('first', Label(id=id, name="Hello", description="Hello Desc", color="#fff")))
    ...
    def test_get_by_id(self, mock_sqlalchemy_orm):
        ...
        id = uuid4()
        db = mock_sqlalchemy_orm(
            ['query', 'filter'], ('first', Label(id=id, name="Hello",
                                                 description="Hello Desc", color="#fff")))
